                      ...
                      {workerDetail.attendance?.map((a: any) => (
                        <tr key={a.id} className="group hover:bg-white/[0.01] transition-colors">
                          ...
                          <td className="py-4 text-right">
                            ...
                            }} className="h-11 w-11 md:h-9 md:w-9 flex items-center justify-center rounded-xl hover:bg-red-500/10 text-zinc-600 hover:text-red-400 transition-all ml-auto"><Trash2 className="w-4 h-4" /></button>
                          </td>
                        </tr>
                      ))}
                    </tbody>
