...
export default function BakeryInventoryPage() {
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6 max-w-[1400px] mx-auto">
      <div><h1 className="text-2xl font-bold text-zinc-100">Bakery Inventory</h1><p className="text-sm text-zinc-500">Track raw materials and product stock</p></div>
      <div className="rounded-2xl border border-purple-500/10 bg-purple-500/5 p-8 text-center">
        ...
        <p className="text-sm text-zinc-500">Bakery inventory tracking — linked to products.</p>
      </div>
    </motion.div>
  );
}
